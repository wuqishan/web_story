            ...
            <div class="content">
                ...
                <article class="excerpt excerpt-1"><a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）"
                                                      target="_blank"><img class="thumb"
                                                                           ...
                                                                           src="{{ asset('/static/images/201610181739277776.jpg') }}"
                ...
                <article class="excerpt excerpt-2"><a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）"
                                                      target="_blank"><img class="thumb"
                                                                           data-original="images/201610181739277776.jpg"
                                                                           src="{{ asset('/static/images/201610181739277776.jpg') }}"
                                                                           alt="用DTcms做一个独立博客网站（响应式模板）"
                ...
                <article class="excerpt excerpt-3"><a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）"
                                                      target="_blank"><img class="thumb"
                                                                           data-original="images/201610181739277776.jpg"
                                                                           src="{{ asset('/static/images/201610181739277776.jpg') }}"
                                                                           alt="用DTcms做一个独立博客网站（响应式模板）"
                ...
                <article class="excerpt excerpt-4"><a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）"
                                                      target="_blank"><img class="thumb"
                                                                           data-original="images/201610181739277776.jpg"
                                                                           src="{{ asset('/static/images/201610181739277776.jpg') }}"
                                                                           alt="用DTcms做一个独立博客网站（响应式模板）"
                ...
                <article class="excerpt excerpt-5"><a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）"
                                                      target="_blank"><img class="thumb"
                                                                           data-original="images/201610181739277776.jpg"
                                                                           src="{{ asset('/static/images/201610181739277776.jpg') }}"
                                                                           alt="用DTcms做一个独立博客网站（响应式模板）"
...
<img class="thumb" data-original="images/201610181739277776.jpg" src="{{ asset('/static/images/201610181739277776.jpg') }}"
...
2016-11-01
            ...
            <div class="widget widget_sentence">
                ...
                <a href="#" target="_blank" rel="nofollow" title="MZ-NetBlog主题">
                    <img style="width: 100%" src="{{ asset('/static/images/ad.jpg') }}" alt="MZ-NetBlog主题"></a>

            </div>
            <div class="widget widget_sentence">

                <a href="#" target="_blank" rel="nofollow" title="专业网站建设">
                    <img style="width: 100%" src="{{ asset('/static/images/201610241224221511.jpg') }}" alt="专业网站建设"></a>
