<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="{{ route('admin.admin.index') }}">有趣的灵魂</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li>
                    <a class="dropdown-item" href="javascript:$.sys_reset_cache('{{ route('admin.setting.reset_cache') }}', {'_token': '{{ csrf_token() }}'})">
                        <i class="fa fa-user fa-lg"></i> 重置缓存
                    </a>
                </li>
                <li>
