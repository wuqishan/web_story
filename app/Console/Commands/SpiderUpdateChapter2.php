...
class SpiderUpdateChapter2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:spider-chapter2 {category_id?}';
...
//        print_r($books_new);exit;

        $tookit = new Toolkit();
        CurlMultiHelper::get(array_keys($books_new), function ($ql, $curl, $r) use ($tookit, $books_new) {
